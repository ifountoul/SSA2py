...
def clipAutoDetect(trace, threshold = 0.999, sigma = 0.001):
   """
   ...
   trace: Obspy trace object
       Trace
   threshold: float
       Threshold for peak amplitude.Usually 0.9-0.98
   sigma: float 
       A small amplitude of random serial to purturb the peak amplitude. Usually 0.0001-0.001

   Returns:
   --------
   (True/False, Array with containing the Clipped Samples): tuple
   """
